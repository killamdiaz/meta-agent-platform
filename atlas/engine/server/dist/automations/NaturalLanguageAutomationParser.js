...
const KEY_REQUIRED_AGENTS = new Set([
    'JiraAgent',
    'JiraTrigger',
    'NotionAgent',
    'DiscordAgent',
...
function buildCronConfig(input) {
...
function buildJiraConfig(input) {
...
function generateNodeId(agent, suffix) {
...
export class NaturalLanguageAutomationParser {
    ...
    inferTrigger(description, existingActionAgents) {
    ...
    inferOutput(description, triggerAgent, existingActionAgents = []) {
        const lower = description.toLowerCase();
        ...
        if (!existingActionAgents.includes('EmailSenderAgent') &&
        ...
        if (!existingActionAgents.includes('SlackAgent') &&
    ...
    buildTriggerFromPattern(agent, description) {
    ...
    buildActionFromPattern(agent, description) {
    ...
    inferName(input, triggerAgent, actionAgents) {
    ...
    tryBuildAtlasIntegration(input) {
