...
const runtime = new UniversalConnectorRuntime(vault, axios.create({ timeout: config.connectorRuntimeTimeoutMs || 15000 }));
...
// Legacy platform-specific routes (Slack/Jira)
