...
const resolveToken = (overrides) => {
    return (trim(overrides?.token) ??
...
const resolveAgentId = (candidate, overrides) => {
    return (trim(overrides?.agentId) ??
...
export function buildAtlasBridgeOptions(agentId, overrides) {
