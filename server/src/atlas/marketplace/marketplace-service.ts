...
import { ConnectorStore } from '../core/connector-store.js';
import { MarketplaceConnector, StoredConnectorPackage } from '../core/types.js';
...
export class MarketplaceService {
  ...
  async downloadAsZip(connectorId: string) {
  ...
  private async buildZip(connector: StoredConnectorPackage) {
    const zip = new JSZip();
